...
#define BTN_JUMP 21
#define BTN_RESET 26 //// Change GPIO 26 to 22 to avoid I2C SDA conflict? BTN_RESET is set to GPIO 26 in main.c, but I2C_SDA is also set to GPIO 26 in storage.c
