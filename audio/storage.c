...
void update_high_score(int current_score) { ////update_high_score is void. The game doesn't know if it should play the "Death" sound or the "Celebration" sound. By returning a bool, we allow the audio trigger to be conditional.
